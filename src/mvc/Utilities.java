...
public class Utilities {
    ...
    // save model
    public static void save(Model model, Boolean saveAs) throws NullPointerException{
        ...
        try {
            ...
            Utilities.error("Save error");  //Added to fix NullPointerException
        }
    }
    ...
    public static Model open(Model model) {
        ...
        try {
            ...
            //Utilities.error(err);
            Utilities.error("Open error");  //Added to fix NullPointerException
        }
        return newModel;
    }
